...
namespace Ue5
{
    class FeatureEdges : public Feature
    {
        private:
            ...
            //! 2D sobelX filter split into two 1D filters, split0
            static const int filter_sobelX1D0[3][1];

            //! 2D sobelX filter split into two 1D filters, split1
            static const int filter_sobelX1D1[1][3];

            //! 2D sobelY filter split into two 1D filters, split0
            static const int filter_sobelY1D0[3][1];

            //! 2D sobelY filter split into two 1D filters, split1
            static const int filter_sobelY1D1[1][3];

            //! 2D gauss filter split into two 1D filters, split0
            static const int filter_gauss1D0[3][1];

            //! 2D gauss filter split into two 1D filters, split1
